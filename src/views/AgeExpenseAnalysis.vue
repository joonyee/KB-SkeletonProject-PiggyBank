...
const filteredMySpending = computed(() =>
  allLabels
    .map((label, idx) =>
      selectedCategories.value.includes(label) ? mySpending[idx] : null
    )
    .filter((val) => val !== null)
);
const filteredAvgSpending = computed(() =>
  allLabels
    .map((label, idx) =>
      selectedCategories.value.includes(label) ? avgSpending[idx] : null
    )
    .filter((val) => val !== null)
);
...
// const avgSpending = [65000, 25000, 45000, 80000, 600000];
</script>
...
const mySpending = [70000, 23000, 120000, 40000, 300000, 15000, 60000, 17000, 80000, 10000];
const avgSpending = [60000, 20000, 80000, 50000, 280000, 20000, 55000, 15000, 60000, 12000];
